					...
					<div class="d-flex align-items-center justify-content-end">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Trang
									chủ</li>
							</ol>
						</nav>
					</div>
							...
							<div class="mt-4">
								<div class="row text-center">
									<div class="col-6 border-right">
										<h4 class="mb-0">58%</h4>
										<span class="font-14 text-muted">Khách hàng tiềm năng</span>
									</div>
									<div class="col-6">
										<h4 class="mb-0">42%</h4>
										<span class="font-14 text-muted">Khách hàng cũ</span>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="card">
						...
						<div class="comment-widgets" style="height: 430px;">
							...
							<div class="d-flex flex-row comment-row mt-0">
								<div class="p-2">
									<img
										src="<c:url value='/resources/img/users/1.jpg'/>"
										alt="user" width="50" class="rounded-circle">
								</div>
								<div class="comment-text w-100">
									<h6 class="font-medium">James Anderson</h6>
									<span class="mb-3 d-block">Lorem Ipsum is simply dummy
										text of the printing and type setting industry. </span>
							...
							<div class="d-flex flex-row comment-row">
								<div class="p-2">
									<img
										src="<c:url value='/resources/img/users/4.jpg'/>"
										alt="user" width="50" class="rounded-circle">
								</div>
							...
							<div class="d-flex flex-row comment-row">
								<div class="p-2">
									<img
										src="<c:url value='/resources/img/users/5.jpg'/>"
										alt="user" width="50" class="rounded-circle">
								</div>
								<div class="comment-text w-100">
							...
							<div class="d-flex flex-row comment-row mt-0">
								<div class="p-2">
									<img
										src="<c:url value='/resources/img/users/2.jpg'/>"
										alt="user" width="50" class="rounded-circle">
								</div>
								<div class="comment-text w-100">
						...
						<div class="card-body">
							...
							<ul class="row list-style-none text-center mt-4">
								<li class="col-3">
									...
									</h4> <span class="d-block text-muted">09:30</span>
									<h3 class="mt-1">
										70<sup>°</sup>
									</h3>
								</li>
								<li class="col-3">
									...
									</h4> <span class="d-block text-muted">11:30</span>
									<h3 class="mt-1">
										72<sup>°</sup>
									</h3>
								</li>
								<li class="col-3">
									...
									</h4> <span class="d-block text-muted">13:30</span>
									<h3 class="mt-1">
										75<sup>°</sup>
									</h3>
								</li>
								<li class="col-3">
									...
									</h4> <span class="d-block text-muted">15:30</span>
									<h3 class="mt-1">
										76<sup>°</sup>
									</h3>
								</li>

...
<head>
	<title>Sách Về Lĩnh Vực Kinh Tế</title>
    <meta charset="UTF-8">   
</head>
...
<body>
    ...
    <section class="breadcrumbbar">
        <div class="container">
            <ol class="breadcrumb mb-0 p-0 bg-transparent">
                ...
                <li class="breadcrumb-item active"><a href="../book/sachKinhTe">Sách kinh tế - kỹ năng</a></li>
            </ol>
        </div>
    </section>
    ...
    <section class="banner">
        <div class="container">
            <a href="../book/sachMoiTuyenChon"><img src="<c:url value='/resources/images/banner-sach-ktkn.jpg'/>" alt="banner-sach-ktkn"
                    class="img-fluid"></a>
        </div>
    </section>
            ...
            <div class="the-loai-sach">
                <ul class="list-unstyled d-flex">
                    <li>
                        <a href="#" class="danh-muc text-decoration-none">
                            <div class="img text-center">
                                <img src="<c:url value='/resources/images/tls-kinh-te-chinh-tri.png'/>" alt="tls-kinh-te-chinh-tri">
                            </div>
                            <div class="ten">
                                Kinh tế - chính trị
                            </div>
                    ...
                    <li>
                        <a href="#" class="danh-muc text-decoration-none">
                            <div class="img text-center">
                                <img src="<c:url value='/resources/images/tls-nhan-vat-bai-hoc-kinh-doanh.png'/>" alt="tls-kinh-te-chinh-tri">
                            </div>
                            <div class="ten">
                    ...
                    <li>
                        <a href="#" class="danh-muc text-decoration-none">
                            <div class="img text-center">
                                <img src="<c:url value='/resources/images/tls-sach-khoi-nghiep.png'/>" alt="tls-kinh-te-chinh-tri">
                            </div>
                            <div class="ten">
                                Sách Khởi Nghiệp
                            </div>
                    ...
                    <li>
                        <a href="#" class="danh-muc text-decoration-none">
                            <div class="img text-center">
                                <img src="<c:url value='/resources/images/tls-sach-quan-tri-lanh-dao.png'/>" alt="tls-kinh-te-chinh-tri">
                            </div>
                            <div class="ten">
                    ...
                    <li>
                        <a href="#" class="danh-muc text-decoration-none">
                            <div class="img text-center">
                                <img src="<c:url value='/resources/images/tls-sach-tai-chinh-ke-toan.png'/>" alt="tls-kinh-te-chinh-tri">
                            </div>
                            <div class="ten">
                    ...
                    <li>
                        <a href="#" class="danh-muc text-decoration-none">
                            <div class="img text-center">
                                <img src="<c:url value='/resources/images/tls-sach-kinh-te-hoc.png'/>" alt="tls-kinh-te-chinh-tri">
                            </div>
                            <div class="ten">
                                Sách Kinh tế học
                            </div>
                    ...
                    <li>
                        <a href="#" class="danh-muc text-decoration-none">
                            <div class="img text-center">
                                <img src="<c:url value='/resources/images/tls-sach-quan-tri-nhan-su.png'/>" alt="tls-kinh-te-chinh-tri">
                            </div>
                            <div class="ten">
                    ...
                    <li>
                        <a href="#" class="danh-muc text-decoration-none">
                            <div class="img text-center">
                                <img src="<c:url value='/resources/images/tls-sach-chung-khoan-bat-dong-san-dau-tu.png'/>"
                    ...
                    <li>
                        <a href="#" class="danh-muc text-decoration-none">
                            <div class="img text-center">
                                <img src="<c:url value='/resources/images/tls-sach-ky-nang-lam-viec.png'/>" alt="tls-kinh-te-chinh-tri">
                            </div>
                            <div class="ten">
                    ...
                    <li>
                        <a href="#" class="danh-muc text-decoration-none">
                            <div class="img text-center">
                                <img src="<c:url value='/resources/images/tls-sach-marketing-ban-hang.png'/>" alt="tls-kinh-te-chinh-tri">
                            </div>
                            <div class="ten">
                            ...
                            <div class="col-lg-3 col-md-4 col-xs-6 item DeanGraziosi">
                                <div class="card ">
                                    <a href="product-item.html" class="motsanpham"
                                        ...
                                        <img class="card-img-top anh" src="<c:url value='/resources/images/lap-ke-hoach-kinh-doanh-hieu-qua.jpg'/>"

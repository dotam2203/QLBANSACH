...
<html lang="li">
<head>
	<title>Ma Bùn Lưu Manh Và Những Câu Chuyện Khác Của NGUYỄN TRÍ</title>
    <meta charset="UTF-8">
</head>
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 khoianh">
                        <div class="anhto mb-4">
                            <a class="active" href="<c:url value='/resources/images/ma-bun-luu-manh-mt.jpg'/>" data-fancybox="thumb-img">
                                <img class="product-image" src="<c:url value='/resources/images/ma-bun-luu-manh-mt.jpg'/>" alt="ma-bun-luu-manh-mt" style="width: 100%;">
                            </a>
                        </div>
                        <div class="list-anhchitiet d-flex mb-4" style="margin-left: 2rem;">
                            <img class="thumb-img thumb1 mr-3" src="<c:url value='/resources/images/ma-bun-luu-manh-mt.jpg'/>" class="img-fluid" alt="ma-bun-luu-manh-mt">
                        </div>
                    </div>
                    ...
                    <div class="col-md-7 khoithongtin">
                        <div class="row">
                            <div class="col-md-12 header">
                                <h4 class="ten">Ma Bùn Lưu Manh Và Những Câu Chuyện Khác Của NGUYỄN TRÍ</h4>
                                <div class="rate">

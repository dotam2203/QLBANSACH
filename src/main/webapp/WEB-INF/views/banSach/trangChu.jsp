                    ...
                    <div id="carouselId" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <a href="#"><img src="<c:url value='/resources/images/banner-sach-moi.jpg'/>" class="img-fluid"
                                        style="height: 386px;" width="900px" alt="First slide"></a>
                            </div>
                            <div class="carousel-item">
                                <a href="#"><img src="<c:url value='/resources/images/banner-beethoven.jpg'/>" class="img-fluid"
                                        style="height: 386px;" width="900px" alt="Second slide"></a>
                            </div>
                            <div class="carousel-item">
                                <a href="#"><img src="<c:url value='/resources/images/neu-toi-biet-duoc-khi-20-full-banner.jpg'/>" class="img-fluid"
		...
		<div class="container">
			<div class="noidung" style="width: 100%;">
				...
				<div class="khoisanpham" style="padding-bottom: 2rem;">
					<!-- 1 san pham -->
					<div class="card">
						<a href="../book/lapKeHoachKinhDoanhHieuQua"
							...
							src="<c:url value='/resources/images/lap-ke-hoach-kinh-doanh-hieu-qua.jpg'/>"
					...
					<div class="card">
						<a
							href="../book/sachNguyenTri"
							class="motsanpham" style="text-decoration: none; color: black;"
							data-toggle="tooltip" data-placement="bottom"
							title="Ma Bùn Lưu Manh Và Những Câu Chuyện Khác Của Nguyễn
                        Trí">
							<img class="card-img-top anh" src="<c:url value='/resources/images/ma-bun-luu-manh.jpg'/>"
							alt="ma-bun-luu-manh">
							<div class="card-body noidungsp mt-3">
					...
					<div class="card">
						<a href="#" class="motsanpham"
							...
							<img class="card-img-top anh" src="<c:url value='/resources/images/bank-4.0.jpg'/>"
							alt="bank-4.0">
							<div class="card-body noidungsp mt-3">
					...
					<div class="card">
                        ...
                        Tình Thân (Bộ 8 Cuốn)">
							...
							src="<c:url value='/resources/images/bo-sach-500-cau-chuyen-dao-duc.jpg'/>"
					...
					<div class="card">
						<a href="#" class="motsanpham"
							...
							class="card-img-top anh"
							src="<c:url value='/resources/images/ung-thu-hoang-de-cua-bach-benh.jpg'/>"
					...
					<div class="card">
						<a href="#" class="motsanpham"
							...
							class="card-img-top anh" src="<c:url value='/resources/images/troi-dem-huyen-dieu.jpg'/>"
					...
					<div class="card">
						<a href="#" class="motsanpham"
							...
							<img class="card-img-top anh"
							src="<c:url value='/resources/images/bo-sach-nhung-cau-chuyen-cho-con-thanh-nguoi-tu-te.jpg'/>"
					...
					<div class="card">
						<a href="#" class="motsanpham"
							...
							src="<c:url value='/resources/images/lich-su-the-gioi.jpg" alt="lich-su-the-gioi'/>">
							<div class="card-body noidungsp mt-3">
				...
				<div class="khoisanpham">
					<div class="card">
						<a href="#" class="motsanpham"
							...
							class="card-img-top anh"
							src="<c:url value='/resources/images/combo-chuyen-nghe-chuyen-doi.jpg'/>"
					...
					<div class="card">
						<a href="#" class="motsanpham"
							...
							class="card-img-top anh"
							src="<c:url value='/resources/images/combo-me-con-su-tu-bo-tat-ngan-tay-ngan-mat.jpg'/>"
					...
					<div class="card">
						<a href="#" class="motsanpham"
							...
							<img class="card-img-top anh"
							src="<c:url value='/resources/images/combo-hanh-phuc-sang-tao.jpg'/>"
					...
					<div class="card">
						<a href="#" class="motsanpham"
							...
							<img class="card-img-top anh"
							src="<c:url value='/resources/images/combo-giao-duc-va-y-nghia-cuoc-song.jpg'/>"
					...
					<div class="card">
						<a href="#" class="motsanpham"
							...
							class="card-img-top anh"
							src="<c:url value='/resources/images/combo-dinh-duong-than-duoc-xanh.jpg'/>"
					...
					<div class="card">
						<a href="#" class="motsanpham"
							...
							class="card-img-top anh" src="<c:url value='/resources/images/combo-an-xanh-song-lanh.jpg'/>"
					...
					<div class="card">
						<a href="#" class="motsanpham"
							...
							<img class="card-img-top anh"
							src="<c:url value='/resources/images/combo-luoc-su-loai-nguoi.jpg'/>"
					...
					<div class="card">
						<a href="#" class="motsanpham"
							...
							class="card-img-top anh" src="<c:url value='/resources/images/combo-phong-cach-song.jpg'/>"
				...
				<div class="khoisanpham">
					...
					<div class="card">
						<a href="#" class="motsanpham"
							...
							class="card-img-top anh"
							src="<c:url value='/resources/images/ngoai-giao-cua-chinh-quyen-sai-gon.jpg'/>"
					...
					<div class="card">
						<a href="#" class="motsanpham"
							...
							src="<c:url value='/resources/images/duong-may-tren-dat-hoa.jpg'/>"
					...
					<div class="card">
						<a href="#" class="motsanpham"
							...
							src="<c:url value='/resources/images/muon-kiep-nhan-sinh.jpg'/>" alt="muon-kiep-nhan-sinh">
							<div class="card-body noidungsp mt-3">
					...
					<div class="card">
						<a href="#" class="motsanpham"
							...
							class="card-img-top anh"
							src="<c:url value='/resources/images/duong-may-trong-coi-mong.jpg'/>"
					...
					<div class="col-lg col-sm-4">
						<div class="card">
							<a href="#" class="motsanpham"
								...
								class="card-img-top anh" src="<c:url value='/resources/images/tung-buoc-chan-no-hoa.jpg'/>"
					...
					<div class="col-lg col-sm-4">
						<div class="card">
							<a href="#" class="motsanpham"
								...
								class="card-img-top anh"
								src="<c:url value='/resources/images/cam-on-vi-da-duoc-thuong.jpg'/>"
					...
					<div class="col-lg col-sm-4">
						<div class="card">
							<a href="#" class="motsanpham"
								...
								<img class="card-img-top anh" src="<c:url value='/resources/images/vua-gia-long.jpg'/>"
								alt="vua-gia-long">
								<div class="card-body noidungsp mt-3">
					...
					<div class="col-lg col-sm-4">
						<div class="card">
							<a href="#" class="motsanpham"
								...
								<img class="card-img-top anh"
								src="<c:url value='/resources/images/suoi-nguon-va-cai-toi-trong-tung-ca-the.jpg'/>"
					...
					<div class="col-lg col-sm-4">
						<div class="card cuoicung">
							<a href="#" class="motsanpham"
								...
								class="card-img-top anh"
								src="<c:url value='/resources/images/dai-dich-tren-con-duong-to-lua.jpg'/>"
